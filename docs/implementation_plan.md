...
- Manually validate survey submission, duplicate-response rejection, stale survey-picker refresh, dashboard refresh, hierarchy tree scope selection, level scope selection, and Q3-Q5 analysis.
