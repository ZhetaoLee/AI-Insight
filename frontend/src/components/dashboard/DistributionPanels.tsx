...
export function DistributionPanels({ metrics, visibleTitles }: DistributionPanelsProps) {
  ...
  const panels: PanelDef[] = [
    ...
    },
    {
      ...
      rows: metrics.work_output.rows.map((r, idx) => ({
        ...r,
        color: r.code === "not_sure" ? GRAY : idx <= 1 ? RED : GREEN,
      })),
    ...
    },
    {
      ...
      rows: metrics.work_quality.rows.map((r, idx) => ({
        ...r,
        color: r.code === "not_sure" ? GRAY : idx <= 1 ? RED : GREEN,
      })),
    ...
    },
    {
      ...
      rows: metrics.ai_rework_frequency.rows.map((r, idx) => ({
        ...r,
        color: r.code === "not_sure" ? GRAY : idx >= 3 ? RED : GREEN,
      })),
